...
export default {
  ...
  methods: {
    ...
    getChaxun () {
      this.$ajax
        .get('http://192.168.43.33:80/apis/zmm00tY100Erp/?params={"columns":"wid,ext4,supplyplancode,ebeln,ebelp,matnr,maktx,zjjsl,menge,meins,werks,werksdescription,posid,psphi,xmpost1,pratx,zhtbh,zxmdw,username,zfhfqz,zfhfsj,zshfqz,zshfsj,zsjjhq,actualdeliverypl,remark,pstngDate,blart,bwart,bukrs,bukrsdescription,zyjfhq,eindt,suppliername,supplinkman,supplinkmantelep,carrlinkman,carrlinkmantelep,delinkman,delinkmantelepho,msgcode,msgdesp,mblnr,gjahr","pageIndex":1,"pageSize":20}')
        .then(res => {
          // console.log(res.data) // http://127.0.0.1/apis/zmm00tY100Erp
        })
    },
